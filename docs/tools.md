...
| `feature` | Bitrix framework features | `featureType` (one or several of `controller_action`, `route`, `urlrewrite_rule`, `rest_method`, `lang_phrase`, `lang_usage`, `js_extension`, `js_extension_usage`, `autoload_class`, `autoload_namespace`, `user_field`, `iblock_property`, `component_parameter`, `component_description`, `ajax_call`, `js_event`), `query` (name or handler substring; exact matches first), `module`, `kind` |
...
- Example responses:
  ...
  - `{"entity":"feature","featureType":"route"}` → `{"entity":"feature","count":1,"truncated":false,"results":[{"featureType":"route","name":"GET /api/items","target":"Vendor\\Api\\Items::list","kind":"project","file":"local/routes/api.php","line":4,"detail":{"routeName":"items_list"}}]}`
